...
const Payment = () => {
  ...
  useEffect(() => {
    const initializePayment = async () => {
      ...
      try {
        ...
        console.log(
          `Backend respondeu em ${seconds}s`
        );
        ...
        console.log("Backend está pronto para receber o PIX.");
      } catch (error) {
        console.error(
          "Não foi possível acordar o backend:",
          error
        );
        ...
        setPaymentMessage(
          "Não foi possível conectar ao servidor de pagamento. Tente recarregar a página."
        );
      } finally {
  ...
  const gerarPix = async () => {
    ...
    if (!backendReady) {
      setPaymentMessage(
        "Aguarde alguns segundos enquanto preparamos o pagamento PIX."
      );
    ...
    try {
      ...
      console.log(
        `POST /pix/create respondeu em ${seconds}s`
      );
